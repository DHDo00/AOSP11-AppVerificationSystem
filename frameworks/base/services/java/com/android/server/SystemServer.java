...
public final class SystemServer {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
	    ...
	    // DH ↓↓↓
            t.traceBegin("StartAppVerificationManagerService");
            try {
                Slog.i(TAG, "App Verification Manager Service");
                AppVerificationManagerService appVerificationService =
                        new AppVerificationManagerService(context);
                ServiceManager.addService("app_verification", appVerificationService);
            } catch (Throwable e) {
                reportWtf("starting App Verification Manager Service", e);
            }
            t.traceEnd();
            // DH ↑↑↑
            ...
            wm.onInitReady();
            t.traceEnd();
            Slog.i(TAG, "App Verification Manager Service started successfully");
        } catch (Throwable e) {
            reportWtf("starting App Verification Manager Service", e);
        } finally {
            t.traceEnd();
